...
function renderBox(array $box, bool $editable = false)
{
    ...
    <div class="bento-box <?= !$box['on_off'] ? 'disabled' : '' ?>" 
        ...
        <form method="post" class="box-form">
            ...
            <!-- Hover size picker overlay -->
            <div class="size-picker-overlay">
                <?php foreach (['1x1'=>'S','2x1'=>'W','1x2'=>'T','2x2'=>'L'] as $val => $label): ?>
        ...
        <?php else: ?>
            ...
            <div class="box-content"><?= nl2br(htmlspecialchars($box['content'])) ?></div>
        <?php endif; ?>
    </div>
    <?php
}
